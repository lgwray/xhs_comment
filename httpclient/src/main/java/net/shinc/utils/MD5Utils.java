...
public class MD5Utils {
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public static String getMd5Encrypted(String password) throws NoSuchAlgorithmException, UnsupportedEncodingException {
		// 声明加密后的口令数组变量
		byte[] pwd = null;
		// 随机数生成器
	...
	public static void main(String[] args) {
		try {
			String encrypted = getMd5Encrypted("动物保护组织状告英摄影师侵犯猴子知识产权");
