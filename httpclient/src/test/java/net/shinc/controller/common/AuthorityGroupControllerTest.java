...
//	@Transactional
	...
	public void testAddAuthGroupAuth() {
		try {
			...
			list.add(new AuthGroupHasAuth(new AuthorityGroup(1), new Authority(13)));
			list.add(new AuthGroupHasAuth(new AuthorityGroup(1), new Authority(14)));
			list.add(new AuthGroupHasAuth(new AuthorityGroup(1), new Authority(15)));
			
			list.add(new AuthGroupHasAuth(new AuthorityGroup(2), new Authority(1)));
			list.add(new AuthGroupHasAuth(new AuthorityGroup(2), new Authority(2)));
			list.add(new AuthGroupHasAuth(new AuthorityGroup(2), new Authority(3)));
			list.add(new AuthGroupHasAuth(new AuthorityGroup(2), new Authority(4)));
			list.add(new AuthGroupHasAuth(new AuthorityGroup(2), new Authority(5)));
			list.add(new AuthGroupHasAuth(new AuthorityGroup(2), new Authority(6)));
			list.add(new AuthGroupHasAuth(new AuthorityGroup(2), new Authority(7)));
			list.add(new AuthGroupHasAuth(new AuthorityGroup(2), new Authority(8)));
			list.add(new AuthGroupHasAuth(new AuthorityGroup(2), new Authority(9)));
			list.add(new AuthGroupHasAuth(new AuthorityGroup(2), new Authority(10)));
			list.add(new AuthGroupHasAuth(new AuthorityGroup(2), new Authority(11)));
			list.add(new AuthGroupHasAuth(new AuthorityGroup(2), new Authority(12)));
			list.add(new AuthGroupHasAuth(new AuthorityGroup(2), new Authority(13)));
